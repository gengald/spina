...
function registerPushwooshIOS() {
	...
	pushNotification.registerDevice({alert:true, badge:true, sound:true, pw_appid:"73B8F-7FE1C", appname:"push"},
									function(status) {
...
function registerPushwooshAndroid() {
	...
	pushNotification.registerDevice({ projectid: "257001700068", appid : "73B8F-7FE1C" },
									function(token) {
										/* alert(token); */
